            ...
            <div class="col-md-12">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="col-md-12 text-right">
                          <a href="<?=base_url() ?>Office/index10"><button class="btn btn-primary" type="button" name="btn_new" id="btn_new" style="background-color: #d41574;color:white">
                ...
                <table id="table" class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        ...
                        //  echo  '<td><a href="'.base_url().'admin/Keychain/update/'.$value->keychainId.'"><i class="fas fa-eye" style="font-size: 16px;"></i></a> </td>';
                         echo "<td>".$value->TagsId."</td>";  
                         echo "<td>".$value->TagsName."</td>";
