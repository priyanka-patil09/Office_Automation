    ...
    <!-- ***** Added New Scripts*********** -->
      ...
      <script src="<?=base_url() ?>web_resources/dist/js/sweetalert.min.js"></script>


      
    <script src="<?=base_url() ?>Assets/js/select2.min.js"></script>
    <script src="<?=base_url() ?>Assets/js/select2.full.min.js"></script>
    <script src="https://www.government.umikoo.com/assets2/js/select2.init.js"></script>
   <script src="https://www.government.umikoo.com/assets/js/datatables.min.js"> </script>
