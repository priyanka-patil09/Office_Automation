                ...
                <div class="col-md-12">
                    <div class="card-body p-4">
                        <div class="card-title mb-1 py-1">
                            <h2 class="mt-4">&ensp;STATUS INFORMATION</h2>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6 col-6 p-1 ml-5 mt-3">
                                            <div class="form-group">
                                                ...
                                                <div class="field_label">Status Name<span class="text-danger">*</span>
                                                  
                                                            <input type="text" class="form-control" id="StNm" name="StNm"
                                                    value="" style="border-color:black; width: 300px;"placeholder="Enter Status Name">
                                                </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6 col-6 p-1 ml-5 mt-3">
                                            <div class="form-group">
                                                ...
                                                <div class="field_label">Colour Code<span class="text-danger">*</span><br>
                                                    <input type="color" id="favcolor" name="favcolor"
                                                        value="#ff0000" style="width: 200px;border-color:black;"><br><br>
                                                </div>
                            ...
                            <script>
                                ...
                                function saveperform() 
                                {
                                    ...
                                    if (StNm=="" ||favcolor=="") 
                                    {
                                        ...
                                        $.ajax({
                                            url: base_path + "Office/insertStatus",
                                            type: "POST",
                                            data: $('#Form').serialize(),
                                            beforeSend: function () {
