            ...
            <div class="col-md-12">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="card-title mb-1 py-1">
                            <h2>&ensp;TASK TYPE INFORMATION</h2>
                        </div>

                        <div class="col-md-12 text-right">
                          <a href="<?=base_url() ?>Office/index5"><button class="btn btn-primary" type="button" name="btn_new" id="btn_new" style="background-color: #d41574;color:white">
