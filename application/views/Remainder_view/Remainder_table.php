            ...
            <div class="col-md-12">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="card-title mb-1 py-1">
                            <h2>&ensp;REMINDER TYPE INFORMATION</h2>
                        </div>

                        <div class="col-md-12 text-right">
                          <a href="<?=base_url() ?>Office/index3"><button class="btn btn-primary" type="button" name="btn_new" id="btn_new" style="background-color: #d41574;color:white">
                ...
                <table id="table" class="table table-striped table-bordered table-hover">
                    ...
                    <?php 
                        ...
                        //  echo  '<td><a href="'.base_url().'admin/Keychain/update/'.$value->keychainId.'"><i class="fas fa-eye" style="font-size: 16px;"></i></a> </td>';
                         echo "<td>".$value->RemainId."</td>";  
                         echo "<td>".$value->RemainName."</td>";
