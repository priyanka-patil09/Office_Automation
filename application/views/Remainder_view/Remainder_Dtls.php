                ...
                <div class="col-md-12">
                    <div class="card-body p-4">
                        <div class="card-title mb-1 py-1">
                            <h2 class="mt-4">&ensp;REMINDER TYPE INFORMATION</h2>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6 col-6 px-1 ml-5 mt-3">
                                            <div class="form-group">
                                                ...
                                                <div class="field_label">Reminder Type Name<span class="text-danger">*</span>
                                                            <input type="text" class="form-control" id="RemainNm" name="RemainNm"
                                                    value="" style="border-color:black; width: 400px;"placeholder="Enter Reminder Type Name">
                                                </div>
                                ...
                                function saveperform()
                                 {
                                    ...
                                    if (RemainNm=="") 
                                    {
                                        ...
                                        $.ajax({
                                            url: base_path + "Office/insertRemainder",
                                            type: "POST",
                                            data: $('#Form').serialize(),
                                            beforeSend: function () {
